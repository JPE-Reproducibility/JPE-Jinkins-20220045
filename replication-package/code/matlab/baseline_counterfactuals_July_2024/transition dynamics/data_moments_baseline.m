...
% seller frequency counts
Freq_ge_BPS = [116926  % JT: CHECK THIS (source? not sure figures compatible with others)
23562
10384
5700
3535
...
% buyer frequency counts
Freq_ge_SPB = [13786 % JT: CHECK THIS
8180
6143
4900
4012
...
act_NB = 8180;
NS_NB = act_NS/act_NB;
Sprob = act_NS/(act_NB + act_NS);
V_Sprob = Sprob*(1-Sprob)/(8180+23562);
