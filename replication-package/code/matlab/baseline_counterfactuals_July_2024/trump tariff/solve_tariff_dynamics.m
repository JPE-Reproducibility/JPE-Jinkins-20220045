function [Vbx_seq,sbx_seq,Cs_seq,Qbx_seq,Vs1x_seq,Vs2x_seq,Mbx_seq,EVs1_seq,EVs2_seq,u1_seq,u2_seq,QS1_seq,QS2_seq,Ms1_seq,Ms2_seq,Ap_new,thetab1_new,thetab2_new]...
    = solve_tariff_dynamics(x,T,param_indx,param_state,param_fix,thetab1_old,thetab2_old,thetas_old,Ap_old,VbxT,sbxT,CsT,QbxT,Vs1xT,Vs2xT,Mbx1,u11,u21,QS11,QS21,Ms11,Ms21,tauxs1,tauxs2,profxs,pbs,profx)
...
for iter=1:1:100 %iterate for the path convergence
%% iterate backwards
tic
for t = T:-1:2
    ...
    [Vbt,sbt,csbt,Qbt] = val_bt(prof,thetab1,thetab2,Vb,sb,csb,param,param_indx,param_state,param_fix);
