function [cnt_traj,mean_traj,std_traj] = sim_b_no_interdep(vx, thetab1, thetab2, param_fix, TT, phi_vector)
...
phi_1 = phi_vector(1); % endogenous destruction of match with type 1 seller
phi_2 = phi_vector(2); % endogenous destruction of match with type 2 seller
