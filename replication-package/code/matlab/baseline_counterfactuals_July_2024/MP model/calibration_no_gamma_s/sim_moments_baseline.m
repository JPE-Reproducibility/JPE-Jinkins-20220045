...
% model moments for baseline ("old") objective
model_moments_old = [model_cdf_moments; model_mTB; model_mTS; model_moments_concen; model_interm_sh];

% current calibration moments include match-death regression coefficient
model_moments = [model_cdf_moments; model_mTB; model_mTS; model_moments_concen; model_interm_sh; match_death_reg_coef];

% baseline moments (match-death excluded, NS/NB excluded)
model_moments_old = [model_cdf_moments; model_mTB; model_mTS; model_moments_concen; model_interm_sh];
