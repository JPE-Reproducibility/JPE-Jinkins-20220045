function [cnt_traj,mean_traj,std_traj] = sim_b(vx, thetab1, thetab2, param_fix, TT)
...
for i=2:1: I_simB % JT: i will index events for a given buyer
   ...
   %death rate
   drate1=ms1(:,i-1)*(delta+delta_S); % JT: death of match or seller, type-1
   drate2=ms2(:,i-1)*(delta+delta_S); % JT: death of match or seller, type-2
