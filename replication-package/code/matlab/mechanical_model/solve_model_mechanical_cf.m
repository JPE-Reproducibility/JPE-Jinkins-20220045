...
function [thetas,thetab1,thetab2,Ap,U1,U2,V,mMb,Mbx,Vbx,sbx,u1,u2,Vs1x,Vs2x,Ms1,Ms2,Qbx,QS1,QS2,net_prof_b,Cs,Cs1,Cs2,net_prof_s1,net_prof_s2,tauxs1,tauxs2,profxs,pbs,profx] = ...
    solve_model_mechanical_cf(si,x,param_indx,param_state,param_fix)

%% Parameters passed as placeholders for counterfactual code
Ap=0;
Vs1x=0;
Vs2x=0;
net_prof_b = 0;
