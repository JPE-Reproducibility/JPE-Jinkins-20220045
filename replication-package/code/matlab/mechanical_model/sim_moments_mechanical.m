...
% Adapted from sim_moments_baseline to the mechanical model
...
wt_old = param_fix{13};
wt_x = param_fix{14};
Mmax = param_fix{19};  % JT: was param_fix{15} in baseline
%kap_s = param_fix{20};
...
% model_moments = [model_cdf_moments; model_mTB; model_mTS; model_moments_concen;...
%     model_NS_NB; model_interm_sh];  % vector from baseline model

% REMOVE: model_moments_concen, model_intern_sh :
