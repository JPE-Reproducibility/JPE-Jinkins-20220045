...
% dropping NS_NB target
data_moments = [cdf_SPB,cdf_BPS,PTran_mSPB,...
                 PTran_mBPS,data_moments_concen',data_interm_sh, data_match_death_haz, data_match_death_reg_coef]';
Nmom = length(data_moments);
            
% consolidate blocks of covariance matrix
% cov_v  = blkdiag(var_deg_cdf, PsiTrans_mSPB, PsiTrans_mBPS, var_concen, var_interm_sh,var_match_death_haz,var_match_death_reg_coef); 
